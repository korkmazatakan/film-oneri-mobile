...
class Moviesscreenfordirector extends Component {
  ...
  componentDidUpdate(prevProps, prevState) {
    if (prevState.directorId !== this.props.route.params.directorId) {
      ...
      <SafeAreaView style={styles.container}>
        <View
          ...
          <Text style={styles.headerText}>
            {this.props.route.params.directorName}
          </Text>
        </View>
        <View key={this.state.directorId} style={styles.mostReviewed}>
          <ScrollView
            horizontal={false}
...
export default Moviesscreenfordirector;
